# Output Formats — Azure Kubernetes Service Complaints

Always produce **both** a JSON file and a Markdown file.

## 1. JSON (`azure-kubernetes-service-complaints.json`)
...
### Field rules
- `id`: sequential, prefix `aks-` (e.g. `aks-0001`).
...
## 2. Markdown (`azure-kubernetes-service-complaints.md`)

Human-readable report. Suggested structure:

```markdown
# Azure Kubernetes Service — Public Developer Feedback (as of 2026-06-27)
