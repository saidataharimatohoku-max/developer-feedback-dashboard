# Output Formats — Fireworks AI Complaints

Always produce **both** a JSON file and a Markdown file.

## 1. JSON (`fireworks-ai-complaints.json`)
...
### Field rules
- `id`: sequential, prefix `fw-` (e.g. `fw-0001`).
...
## 2. Markdown (`fireworks-ai-complaints.md`)

Human-readable report. Suggested structure:

```markdown
# Fireworks AI — Public Developer Feedback (as of 2026-06-24)
